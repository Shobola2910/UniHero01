...
const ITEMS: Item[] = [
  { emoji: "🤖",      date: "2024 · Dec",  title: "UniHero Bot created",                     img: "/images/unihero-bot-created.png" },
  { emoji: "🧑‍🤝‍🧑", date: "2024 · Oct",  title: "2 anonym founders",                       img: "/images/anonym-founders.png" },
  { emoji: "🧠",      date: "2025 · Mar",  title: "Focused more on AI detectors and others", img: "/images/ai-detectors.png" },
  { emoji: "🎉",      date: "2025 · May",  title: "180+ Students success",                   img: "/images/students-success.png" },
  { emoji: "📥",      date: "2025 · June", title: "UniHero Bot 200+ users",                  img: "/images/bot-200-users.png" },
];

export default function AboutSection() {
  // Cheksiz aylanish effekti uchun data-ni 2x qilamiz
  ...
  // trackpad vertikalni gorizontalga yo‘naltirish
  useEffect(() => {
    const el = scrollerRef.current;
    if (!el) return;
