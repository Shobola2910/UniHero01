    ...
    <section id="resources" className="mx-auto max-w-6xl px-4 py-10 md:py-14">
      ...
      <div className="relative mt-10 grid gap-8 md:grid-cols-2">
        ...
        <div className="pointer-events-none absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 md:block">
          <div className="grid place-items-center rounded-full border-[10px] border-white/70 p-4" style={{ width: 220, height: 220 }}>
            <span className="text-5xl font-black text-white/95 select-none">U</span>
          </div>
        </div>
      </div>
        ...
        >
          ...
          {modal === "assign" && (
            <div className="uh-card w-full max-w-xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-6">
                <a className="inline-flex items-center justify-center rounded-full bg-white/15 px-6 py-3 text-lg font-semibold hover:bg-white/20"
                   href="https://t.me/UniHero_BOT?start=assignments" target="_blank" rel="noopener noreferrer">Order</a>
              </div>
            </div>
          )}
          ...
          {modal === "exam" && (
            <div className="uh-card w-full max-w-xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="mt-3 text-white/80">Barcha exam resourcelarni UniHero BOT’dan olishingiz mumkin.</p>
              <div className="mt-6">
                <a className="inline-flex items-center justify-center rounded-full bg-white/15 px-6 py-3 text-lg font-semibold hover:bg-white/20"
                   href="https://t.me/UniHero_BOT?start=exam_prep" target="_blank" rel="noopener noreferrer">Join!</a>
              </div>
            </div>
          )}
          ...
          {modal === "motivation" && (
            <div className="uh-card w-full max-w-2xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="mt-3 text-sm text-white/70">* Ro‘yxatni <code>QUOTES</code> massiviga qo‘shib kengaytirishingiz mumkin.</p>
            </div>
          )}
          ...
          {modal === "guides" && (
            <div className="uh-card w-full max-w-xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-6">
                <a className="inline-flex items-center justify-center rounded-full bg-white/15 px-6 py-3 text-lg font-semibold hover:bg-white/20"
                   href="https://t.me/UniHero_BOT?start=study_guides" target="_blank" rel="noopener noreferrer">Download</a>
              </div>
            </div>
          )}
          ...
          {modal === "hub" && (
            <div className="uh-card w-full max-w-xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <a className="inline-flex items-center gap-2 rounded-full bg-white/12 px-5 py-2.5 text-base font-semibold hover:bg-white/20"
                   href="https://t.me/UniHero_news" target="_blank" rel="noopener noreferrer">📣 UniHero_News</a>
                <a className="inline-flex items-center gap-2 rounded-full bg-white/12 px-5 py-2.5 text-base font-semibold hover:bg-white/20"
                   href="https://t.me/UniHero_BOT" target="_blank" rel="noopener noreferrer">🤖 UniHero BOT</a>
                <a className="inline-flex items-center gap-2 rounded-full bg-white/12 px-5 py-2.5 text-base font-semibold hover:bg-white/20"
                   href="https://t.me/Unihero_admin" target="_blank" rel="noopener noreferrer">👨🏻‍💻 Admin</a>
              </div>
            </div>
          )}
          ...
          {modal === "podcasts" && (
            <div className="uh-card w-full max-w-xl rounded-3xl border border-white/10 bg-[#0b274a]/95 p-7 text-white" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="mt-3 text-white/80">“Start learn” ni bosing — ro‘yxatdan tasodifiy kanal/playlist ochiladi.</p>
              <div className="mt-6">
                <a className="inline-flex items-center justify-center rounded-full bg-white/15 px-6 py-3 text-lg font-semibold hover:bg-white/20"
                   href={randomPodcast} target="_blank" rel="noopener noreferrer">Start learn</a>
              </div>
